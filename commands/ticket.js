...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription(
        '**Besoin d\'aide ?** Sélectionne la catégorie correspondant à ta demande dans le menu ci-dessous.\n\nUn ticket privé sera créé et notre équipe te répondra dans les plus brefs délais.'
      )
      .setColor(0x5865F2)
      .addFields(
        { name: '🐛 Bug Report', value: 'Signaler un bug dans le jeu', inline: true },
        { name: '💡 Suggestion', value: 'Proposer une idée pour le jeu', inline: true },
        { name: '⚖️ Sanction', value: 'Contester une sanction reçue', inline: true },
        { name: '🤝 Partenariat', value: 'Proposer un partenariat', inline: true },
        { name: '❓ Question', value: 'Poser une question générale', inline: true },
